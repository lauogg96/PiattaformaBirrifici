...
public class TC54Test {
  ...
  public void tC54() {
    ...
    driver.findElement(By.cssSelector(".slidesotto:nth-child(2) li:nth-child(2)")).click();
    ...
    driver.findElement(By.id("in")).sendKeys("Weiss3");
    ...
    driver.findElement(By.name("gradazione")).sendKeys("5");
    ...
    driver.findElement(By.name("quantitaAgg")).sendKeys("4");
