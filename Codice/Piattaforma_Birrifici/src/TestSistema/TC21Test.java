...
public class TC21Test {
  ...
  @Test
  public void tC21() {
    driver.get("http://localhost:8080/Piattaforma_Birrifici/Home.jsp/Piattaforma_Birrifici/Home.jsp");
    ...
    driver.findElement(By.name("email")).sendKeys("bi");
    ...
    driver.findElement(By.name("indirizzo")).sendKeys("via del centenar");
    driver.findElement(By.name("indirizzo")).sendKeys(Keys.DOWN);
    driver.findElement(By.name("indirizzo")).sendKeys(Keys.DOWN);
