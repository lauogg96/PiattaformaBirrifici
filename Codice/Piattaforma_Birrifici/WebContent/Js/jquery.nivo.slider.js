...
(function($) {
	...
	$.fn.nivoSlider.defaults = {
		effect: 'slider', //Imposta l'effetto di transizione
		slices: 15, //Imposta le caratteristiche visive di alcune transizioni
		animSpeed: 1000, //Velocit� della transizione in millisecondi, 500 = mezzo secondo
		pauseTime: 2000, //Durata della visualizzazione dell'immagine in millisecondi, 3000 = 3 secondi
